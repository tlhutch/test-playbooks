pipeline {
    ...
    parameters {
        choice(
            ...
            choices: ['3.4.1', '3.4.0', '3.3.4', '3.3.3', '3.3.2', '3.3.1', '3.3.0',
            ...
            steps {
                script {
                    if (params.TOWERQA_BRANCH == '') {
                        if (params.TOWER_VERSION_TO_UPGRADE_FROM =~ /3\.1\.[0-9]*/) {
                            branch_name = 'release_3.1'
                        } else if (params.TOWER_VERSION_TO_UPGRADE_FROM =~ /3\.2\.[0-9]*/) {
                            branch_name = 'release_3.2'
                        } else {
               ...
               script {
                   if (params.TOWERQA_BRANCH == '') {
                       if (params.TOWER_VERSION_TO_UPGRADE_TO == 'devel') {
                           branch_name = 'devel'
                       } else if (params.TOWER_VERSION_TO_UPGRADE_TO =~ /3\.2\.[0-9]*/) {
                           branch_name = 'release_3.2'
                       } else {
