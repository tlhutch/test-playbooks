pipeline {
    ...
    parameters {
        choice(
            ...
            choices: ['3.6.1', '3.6.0',
                      '3.5.3', '3.5.2', '3.5.1', '3.5.0', '3.4.5', '3.4.4', '3.4.3', '3.4.2', '3.4.1', '3.4.0',
        ...
        always {
            ...
            node('jenkins-jnlp-agent') {
                script {
                    ...
                    json = "{\"tower\":\"${params.TOWER_VERSION_TO_UPGRADE_TO}\", \"bundle\":\"${params.BUNDLE}\", \"url\": \"${env.RUN_DISPLAY_URL}\", \"component\":\"${component}\", \"status\":\"${currentBuild.result}\", \"tls\":\"false\", \"fips\":\"${params.AWX_USE_FIPS}\", \"deploy\":\"${params.SCENARIO}\", \"platform\":\"${params.PLATFORM}\", \"ansible\":\"${params.ANSIBLE_VERSION}\"}"
                }
