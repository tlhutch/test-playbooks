...
Scope selected: ${params.SCOPE}"""
        ...
        stage('Operating System') {
            steps {
                script {
                    def tasks = [:]
                    def oses = ['rhel-7.4-x86_64', 'rhel-7.5-x86_64', 'rhel-7.6-x86_64', 'rhel-8.0-x86_64', 'centos-7.latest-x86_64']

                    if (params.SCOPE == 'latest') {
                        oses = ['rhel-7.6-x86_64', 'rhel-8.0-x86_64']
                    } else {
                        oses = ['rhel-7.4-x86_64', 'rhel-7.5-x86_64', 'rhel-7.6-x86_64', 'rhel-8.0-x86_64', 'centos-7.latest-x86_64']
                    }
