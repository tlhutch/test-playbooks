...
class TestResourceProfiling(APITest):
    ...
    def test_performance_stats_files_created(self, ansible_adhoc, skip_if_openshift, resource_profiling_enabled, factories):
    ...
    def test_performance_stats_intervals_are_applied(self, ansible_adhoc, update_setting_pg, v2, factories, skip_if_openshift, resource_profiling_enabled):
        system_settings = v2.settings.get().get_endpoint('jobs')
    ...
    def test_performance_stats_generated_on_isolated_nodes(self, ansible_adhoc, update_setting_pg, v2, factories, skip_if_openshift, skip_if_not_cluster, resource_profiling_enabled):
