...
def test_unauthenticated(api, resource, method, authtoken, no_license):
    ...
    exceptions = {'/api/v1/authtoken/': {'HEAD': (httplib.METHOD_NOT_ALLOWED, 'head'),
                  ...
                  '/api/v1/activity_stream/': {'HEAD': (httplib.PAYMENT_REQUIRED, 'head'),
                  ...
                  '/api/v1/ping/': {'HEAD': (httplib.OK, 'head'),
                                    ...
                                    'PUT': (httplib.METHOD_NOT_ALLOWED, 'put')},
                  '/api/v1/workflow_job_nodes/': {'HEAD': (httplib.PAYMENT_REQUIRED, 'head'),
                                                  'GET': payment_required,
                                                  'OPTIONS': payment_required,
                                                  'PATCH': payment_required,
                                                  'POST': payment_required,
                                                  'PUT': payment_required},
                  '/api/v1/workflow_job_template_nodes/': {'HEAD': (httplib.PAYMENT_REQUIRED, 'head'),
                                                           'GET': payment_required,
                                                           'OPTIONS': payment_required,
                                                           'PATCH': payment_required,
                                                           'POST': payment_required,
                                                           'PUT': payment_required},
                  '/api/v1/workflow_job_templates/': {'HEAD': (httplib.PAYMENT_REQUIRED, 'head'),
                                                      'GET': payment_required,
                                                      'OPTIONS': payment_required,
                                                      'PATCH': payment_required,
                                                      'POST': payment_required,
                                                      'PUT': payment_required},
                  '/api/v1/workflow_jobs/': {'HEAD': (httplib.PAYMENT_REQUIRED, 'head'),
                                             'GET': payment_required,
                                             'OPTIONS': payment_required,
                                             'PATCH': payment_required,
                                             'POST': payment_required,
...
def test_authenticated(api, resource, method, authtoken, no_license):
    ...
    exceptions = {'/api/v1/activity_stream/': {'HEAD': (httplib.PAYMENT_REQUIRED, 'head'),
                                               'GET': payment_required,
                                               'OPTIONS': payment_required,
                                               'PATCH': payment_required,
                                               'POST': payment_required,
