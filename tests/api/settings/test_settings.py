...
@pytest.fixture
def modify_settings(v1, update_setting_pg):
    ...
    def func():
        ...
        settings_all_pg = v1.settings.get().get_endpoint('all')
        update_setting_pg(settings_all_pg, payload)
        return payload
    return func


@pytest.fixture
def modify_obfuscated_settings(v1, update_setting_pg, unencrypted_rsa_ssh_key_data):
    """Helper fixture used for changing Tower settings."""
    def func():
...
class Test_Setting(Base_Api_Test):
    ...
    def test_included_modules(self, host, ssh_credential, api_ad_hoc_commands_pg, ad_hoc_module_name_choices, v1, update_setting_pg):
        """Verifies that adding additional modules to AD_HOC_COMMANDS unlocks additional modules."""
        # update allowed commands
        settings_jobs_pg = v1.settings.get().get_endpoint('jobs')
        payload = dict(AD_HOC_COMMANDS=['shell'])
        update_setting_pg(settings_jobs_pg, payload)
    ...
    def test_excluded_modules(self, inventory, ssh_credential, api_ad_hoc_commands_pg, ad_hoc_module_name_choices, v1, update_setting_pg):
    ...
    def test_relaunch_with_excluded_module(self, ad_hoc_with_status_completed, v1, update_setting_pg):
    ...
    def test_stdout_max_bytes_display(self, unified_job_with_stdout, v1, update_setting_pg):
    ...
    def test_schedule_max_jobs(self, factories, v1, update_setting_pg):
    ...
    def test_default_job_timeout(self, job_template, v1, update_setting_pg, timeout, default_job_timeout, status, job_explanation):
    ...
    def test_default_inventory_update_timeout(self, custom_inventory_source, v1, update_setting_pg, timeout, default_update_timeout,
    ...
    def test_default_project_update_with_timeout(self, project, v1, update_setting_pg, timeout, default_update_timeout, status,
                                                 job_explanation):
    ...
    def test_activity_stream_enabled(self, factories, api_activity_stream_pg, v1, update_setting_pg):
        ...
        settings_system_pg = v1.settings.get().get_endpoint('system')
        payload = dict(ACTIVITY_STREAM_ENABLED=True)
        update_setting_pg(settings_system_pg, payload)
    ...
    def test_activity_stream_disabled(self, factories, api_activity_stream_pg, v1, update_setting_pg):
    ...
    @pytest.mark.github('https://github.com/ansible/ansible-tower/issues/4098')
    def test_activity_stream_enabled_for_inventory_sync(self, factories, custom_inventory_source, api_activity_stream_pg, v1, update_setting_pg):
    ...
    def test_activity_stream_disabled_for_inventory_sync(self, factories, custom_inventory_source, api_activity_stream_pg, v1, update_setting_pg):
    ...
    def test_org_admins_can_see_all_users(self, org_users, non_org_users, org_admin, api_users_pg, user_password, v1, update_setting_pg):
    ...
    def test_org_admins_cannot_see_all_users(self, org_users, non_org_users, org_admin, api_users_pg, user_password, v1, update_setting_pg):
