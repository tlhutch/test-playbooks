...
class Test_Job_Callback(Base_Api_Test):
    ...
    def test_get(self, api_jobs_pg, ansible_runner, job_template, host_config_key, host_public_ipv4, host_ipv4):
    ...
    def test_launch_no_hosts(self, api_jobs_pg, ansible_runner, job_template, host_config_key, ansible_default_ipv4):
    ...
    def test_launch_no_hosts_match(self, api_jobs_pg, ansible_runner, job_template, host_config_key, ansible_default_ipv4, host_public_ipv4_alias):
    ...
    def test_launch_badkey(self, api_jobs_pg, ansible_runner, job_template, host_ipv4, host_config_key, ansible_default_ipv4):
    ...
    def test_launch_no_credential(self, api_jobs_pg, ansible_runner, job_template_no_credential, host_ipv4, host_config_key, ansible_default_ipv4):
    ...
    def test_launch_ask_credential(self, api_jobs_pg, ansible_runner, job_template_ask, host_ipv4, host_config_key, ansible_default_ipv4):
    ...
    def test_launch_multiple_hosts(self, api_jobs_pg, ansible_runner, job_template, host_ipv4, host_ipv4_again, host_config_key, ansible_default_ipv4):
    ...
    def test_launch_success_limit(self, api_jobs_pg, ansible_runner, job_template_with_limit, host_ipv4, host_config_key, ansible_default_ipv4):
    ...
    def test_launch_success(self, api_jobs_pg, ansible_runner, job_template, host_ipv4, host_config_key, ansible_default_ipv4):
