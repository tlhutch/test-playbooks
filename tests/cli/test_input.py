...
class TestInput(object):
    ...
    def test_bool_casting_true(self, cli, truthy):
        ...
        assert b'\x1b[31m' in result_color.result.stdout, f'cli output doesnt contain color text when it should'
    ...
    def test_bool_casting_false(self, cli, falsy):
        ...
        assert b'\x1b[31m' not in result_no_color.result.stdout, f'cli output contains color text when it shouldn\'t'
