...
# # Enable debug logging (2.3.* and earlier)
# LOGGING['handlers']['django_auth_ldap'] =  {
#     'level': 'DEBUG',
...
# }
#
# LOGGING['loggers']['django_auth_ldap']['handlers'] = ['django_auth_ldap']
# LOGGING['loggers']['django_auth_ldap']['level'] = 'DEBUG'

# Enable debug logging (2.4.0 and beyond)
...
AUTH_LDAP_SERVER_URI = 'ldap://777-777-777.compute-1.amazonaws.com'
